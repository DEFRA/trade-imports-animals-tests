...
test.describe('Commodity selection page', { tag: ['@integration', '@duplicated-in-frontend'] }, () => {
  ...
  test('renders the full grouped checklist', async ({ liveAnimalsPages: pages }) => {
  ...
  test('accepts and persists multiple commodity-species pairs', async ({ liveAnimalsPages: pages }) => {
