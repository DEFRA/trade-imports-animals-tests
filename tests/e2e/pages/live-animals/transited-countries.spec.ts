...
test.describe('Transited countries page', { tag: ['@integration', '@duplicated-in-frontend'] }, () => {
  ...
  test('renders one 31-country checkbox group', async ({ liveAnimalsPages: pages }) => {
  ...
  test('accepts and persists multiple transited countries', async ({ liveAnimalsPages: pages }) => {
