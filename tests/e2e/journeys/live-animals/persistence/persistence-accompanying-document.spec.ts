...
import { type AccompanyingDocumentModel } from '@domain/live-animals/models/db/accompanying-document';
...
test.describe('Accompanying document persistence round-trip', { tag: ['@integration', '@mongodb'] }, () => {
  test('uploads a document that persists to Mongo and reloads', async ({
