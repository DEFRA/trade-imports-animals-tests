import { type CommodityCode, commodityCodes } from '@main-domain/constants/commodity-codes';
import { commoditySpecies, type CommoditySpecies } from '@main-domain/constants/commodity-species';
import { type CommodityType, commodityTypes } from '@main-domain/constants/commodity-types';
import { type CountryCode, countryCodes } from '@main-domain/constants/country-codes';
import { type ImportReason, importReasons } from '@main-domain/constants/import-reasons';
import { type CertificationPurpose, certificationPurposes } from '@main-domain/constants/certification-purposes';
import type { YesNoValue } from '@main-domain/constants/yes-no-values';
import { pointOfEntries, type PointOfEntry } from '@main-domain/constants/point-of-entries';
import { meansOfTransport, type MeansOfTransport } from '@main-domain/constants/means-of-transport';
import type { AccompanyingDocument } from '@main-domain/types/accompanying-document';
