...
import { SqsClient } from '@main-adapters/queue/sqs-client';
import { getDlqUrl } from '@main-config/service-base-urls';
import { outboxEventPaths } from '@main-resources/outbox-events/paths';
