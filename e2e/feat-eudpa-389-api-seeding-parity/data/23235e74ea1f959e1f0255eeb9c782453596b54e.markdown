...
Received string:  "http://localhost:3000/notifications/GBN-AG-26-GCZ906/cancel-amend"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:3000/notifications/GBN-AG-26-GCZ906/cancel-amend"
...
- paragraph:
  ...
  - text: .
- link "Back":
  - /url: /notifications/GBN-AG-26-GCZ906/notification-view
- main:
