...
export const config = {
  ...
  baseUrl: `https://trade-imports-animals-frontend.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `trade-imports-animals-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `trade-imports-animals-tests-${process.env.ENVIRONMENT}`
        },
