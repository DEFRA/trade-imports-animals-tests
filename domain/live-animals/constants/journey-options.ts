import { type CommodityCode, commodityCodes } from '@domain/live-animals/constants/commodity-codes';
import { commoditySpecies, type CommoditySpecies } from '@domain/live-animals/constants/commodity-species';
import { type CommodityType, commodityTypes } from '@domain/live-animals/constants/commodity-types';
import { type CountryCode, countryCodes } from '@domain/live-animals/constants/country-codes';
import { type ImportReason, importReasons } from '@domain/live-animals/constants/import-reasons';
import { type CertificationPurpose, certificationPurposes } from '@domain/live-animals/constants/certification-purposes';
import type { YesNoValue } from '@domain/shared/constants/yes-no-values';
import { pointOfEntries, type PointOfEntry } from '@domain/live-animals/constants/point-of-entries';
import { meansOfTransport, type MeansOfTransport } from '@domain/live-animals/constants/means-of-transport';
import type { AccompanyingDocument } from '@domain/live-animals/types/accompanying-document';
